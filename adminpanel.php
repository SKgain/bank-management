...
<body style="background-color:rgb(176, 230, 181);">
  ...
  <div class="admin-panel">
    ...
    <br><br><br><nav>
      <li><a href="output.php">User Information</a></li>
      <li><a href="IIB.php">Insert Initial Balance</a></li>
      <li><a href="adminuserloginform.html">User Registration</a></li>
      <li><a href="adminFth.php">Fund Transfer History</a></li>
      <li><a href="adminDh.php">Deposit History</a></li>
